...
\begin{description}
\item[Learning OpenCV]\cite{opencv_book-bib}
\item[Tutorial de OpenCV para Python]\cite{opencv_tutorial-bib}
\item[API de OpenCV]\cite{opencv_api-bib}
\end{description}
...
\emph{Numpy} como una matriz de dimensiones $y \times x$,
...
El valor de cada píxel se establece por la media de sus vecinos restándole
una constante C.
...
biblioteca \emph{SimpleCV}. Explicar su funcionamiento requiere
