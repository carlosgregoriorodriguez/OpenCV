...
\begin{figure}[H]
  \centering \setlength\fboxsep{0pt} \setlength\fboxrule{0.5pt}
  \fbox{\includegraphics[width=\textwidth]{imagenes/tecnicas/EjemploTecnicasOpening5.png}}
  \caption{Opening}
\end{figure}
...
\begin{figure}[H]
  \centering \setlength\fboxsep{0pt} \setlength\fboxrule{0.5pt}
  \fbox{\includegraphics[width=\textwidth]{imagenes/tecnicas/EjemploTecnicasClosing5.png}}
  \caption{Opening}
\end{figure}
