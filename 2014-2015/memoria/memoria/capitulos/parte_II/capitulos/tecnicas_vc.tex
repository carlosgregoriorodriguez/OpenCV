...
\begin{figure}[H]
  ...
  \fbox{\includegraphics[width=\textwidth]{imagenes/histogramas/original_histogram.png}}
\end{figure}

\begin{figure}[H]
  \caption{Histograma}
  \centering \setlength\fboxsep{0pt} \setlength\fboxrule{0.5pt}
  \fbox{\includegraphics[scale=0.4]{imagenes/histogramas/histogram.png}}
\end{figure}
...
\begin{figure}[H]
  ...
  \centering \setlength\fboxsep{0pt} \setlength\fboxrule{0.5pt}
  \fbox{\includegraphics[scale=0.4]{imagenes/histogramas/equalization.png}}
\end{figure}

\begin{figure}[H]
  \caption{Original ecualizada}
  \centering \setlength\fboxsep{0pt} \setlength\fboxrule{0.5pt}
  \fbox{\includegraphics[width=\textwidth]{imagenes/histogramas/equalization_histogram.png}}
\end{figure}
...
Las operaciones de \emph{threshold}~\emph{\citep*[Image
  Thresholding]{opencv_tutorial-bib}}~\emph{\citep*[Threshold]{opencv_book-bib}}
convierten los píxeles de una imagen (en escala de grises
$\left[0 \dots 255\right]$) superiores a un valor, conocido como valor
de umbral, a blanco 255 o a negro 0, según el \emph{threshold}
aplicado.
\subsection{Simples}
...
\section{\emph{Blur}}
\emph{Blur}~\emph{\citep*[Smoothing]{opencv_book-bib}~\citep*[3.3.1
  Non-linear filtering]{szeliski2010computer}} o suavizado es una
técnica usada con el objetivo principal de reducir el ruido y los
artefactos (contenido de alta frecuencia) de la imagen, aunque también
se usa para disminuir la resolución. Se basa en aplicar a la imagen un
\emph{kernel} de convolución.
...
\end{equation*}
En el siguiente ejemplo se aplica un Blur basado en una función Gaussiana con \emph{kernel}
de 23 x 23, a partir del cual se calculan las \emph{sigmas}:
...
En el siguiente ejemplo se muestra un ejemplo aplicando un \emph{kernel}
de tamaño 23:
...
\end{equation*}
El siguiente ejemplo muestra el efecto de someter una imagen a una operación
de \emph{Erosion} con un \emph{kernel} de 5 x 5 todo de unos:
...
\end{equation*}
El siguiente ejemplo muestra el efecto de someter una imagen a una operación
de \emph{Dilation} con un \emph{kernel} de 5 x 5 todo de unos:
...
En el siguiente ejemplo se somete a la imagen a un \emph{Opening}
con \emph{kernel} de tamaño 3:
...
\begin{figure}[H]
  \centering \setlength\fboxsep{0pt} \setlength\fboxrule{0.5pt}
  \fbox{\includegraphics[width=\textwidth]{imagenes/tecnicas/EjemploTecnicasOpening3.png}}
  \caption{Opening}
\end{figure}
...
El cálculo de gradientes o bordes \emph{\citep*[11. Feature
  ...
  Derivatives]{opencv_book-bib}} se realiza mediante la convolución de
...
\emph{\citep*[Canny]{opencv_book-bib}} es un algoritmo de detección de
bordes conocido como el \emph{detector óptimo} con la función de
...
El siguiente ejemplo muestra el resultado de aplicar \emph{Canny} a una imagen:
...
\emph{\citep*[4.3.2 Hough transforms]{szeliski2010computer}} es una
técnica que se aplica para encontrar formas en una imagen
\emph{binarizada} o tras haber aplicado un algoritmo de detección de
bordes y contornos como el \emph{Canny}, incluso aunque haya ruido,
siempre que se puedan expresar matemáticamente como líneas rectas y
curvas. Nos centraremos sólo en explicar con rectas.
\subsection{Rectas}
...
\emph{\citep*[Contours in OpenCV]{opencv_tutorial-bib}} se usa para
