...
\mintinline{python}{cv2.createTrackbar()}\footnote{\url{http://docs.opencv.org/modules/highgui/doc/user_interface.html\#cv.CreateTrackbar}}
y
\mintinline{python}{cv2.getTrackbarPos()}\footnote{\url{http://docs.opencv.org/modules/highgui/doc/user_interface.html\#cv2.getTrackbarPos}}.
