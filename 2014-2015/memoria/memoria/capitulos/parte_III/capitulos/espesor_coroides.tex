...
la \emph{\gls{coroides}} y la aparición de la \emph{\gls{uveitis}}. Es
necesario, por tanto, medir el espesor de la \emph{\gls{coroides}} para
prevenir esta
enfermedad y para seguir su evolución en el tiempo.\\
La \emph{\gls{coroides}} o \emph{úvea} es una membrana por la que pasan
gran cantidad de vasos sanguíneos, cuya función es mantener la
temperatura
...
profundo de la retina, conocido como \emph{\gls{fovea}} y de forma
perpendicular a la \emph{\gls{mBruch}}. Una vez trazada la línea,
hay que medirla.
...
evolución y control de la \emph{\gls{uveitis}} una automatización completa
...
\item Corregida la inclinación de la estructura y para poder realizar
  la medición de la \emph{\gls{coroides}}, \textbf{es necesario} previamente
  \textbf{establecer un punto de referencia, la \emph{\gls{fovea}}}. \\
  \textbf{Se desarrolló un algoritmo para la detección del mínimo
    local de la superficie de la retina, la \emph{\gls{fovea}}.}
\item Una vez fijada la \emph{\gls{fovea}} \textbf{se marcan los dos puntos
...
\item Finalmente, \textbf{se realiza la medición del espesor de la
    \emph{\gls{coroides}}}. Este es el proceso más delicado e impreciso de
  ...
  con el mínimo error de precisión posible del espesor de la \emph{\gls{coroides}}. \\
