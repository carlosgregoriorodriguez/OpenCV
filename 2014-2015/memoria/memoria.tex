...
% Paquete para realizar el glosario
...
% Eliminar todas las páginas generadas automáticamente después de cada parte
\makeatletter
...
\include{memoria/capitulos/parte_I/capitulos/introduccion}
\include{memoria/capitulos/parte_I/capitulos/tco}

\include{memoria/capitulos/parte_II/parte_II}
\include{memoria/capitulos/parte_II/capitulos/bibliotecas_vc}
\include{memoria/capitulos/parte_II/capitulos/tecnicas_vc}

\include{memoria/capitulos/parte_III/parte_III}
\include{memoria/capitulos/parte_III/capitulos/plan_trabajo}

\include{memoria/capitulos/parte_IV/parte_IV}

\include{memoria/capitulos/parte_V/parte_V}
\include{memoria/capitulos/parte_V/capitulos/conclusion}
\include{memoria/capitulos/parte_V/capitulos/tiempo_procesamiento}
\include{memoria/capitulos/parte_V/capitulos/futuro}
