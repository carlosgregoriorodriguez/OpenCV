...
% Hacer que al pulsar el índice te vaya al contenido
\usepackage[pdftex]{hyperref}
% Quitar el color distintivo a los enlaces
\hypersetup{hidelinks=true}

\usepackage[refpage]{glosstex}
% Babel no traduce por defecto el título de la lista de acrónimos
...
% Glosario 
\printglosstex(glo)
% Introducimos un término directamente en el glosario
% para que no falle la compilación al estar la lista vacía
\glosstex{GPL}
