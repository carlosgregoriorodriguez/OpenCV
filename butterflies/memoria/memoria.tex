...
Para la prueba del programa \texttt{searchByColor.py} se han tomado las imáganes que se muestran en la figura \ref{todascolor} de la base de datos y éstas se comparan con el ejemplar de la figura \ref{principal1}.
