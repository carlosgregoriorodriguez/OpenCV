...
Después de ésto, aplicamos otra vez \textit{cv2.canny} para encontrar los contornos, pero viendo las imágenes que genera el canny, observamos que acentuar sólo los bordes no es suficiente para encontrar bien el contorno !!!! METER IMAGEN DEL CANNY  !!!(imagen de canny no es suf para cont pero se puede usar como mask con el flood), pero sí que podemos aprovechar los contornos obtenidos como máscara con \textit{cv2.floodfill}. 
