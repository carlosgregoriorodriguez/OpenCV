...
from ../w6/_utils import *
from ../w6/_findStaples import *
from ../w6/_getContours import *
from ../w6/_squareHistogram import *
from ../w6/_fleshBackProyection import *
from ../w6/_findSpot import *
...
def doAndPack(img,dirList,thresh,cannyList,blatList,relevanceThresh,probThresh,level):
	...
	background[0:h,0:w,0:3]=cv2.resize(image,(w,h))
