...
def doAndPack(img,thresh1,thresh2):
	...
	background[0:h,w:2*w]=cv2.cvtColor(cuttedImg,cv2.cv.CV_RGB2GRAY)
	background[0:h,2*w:3*w]=cannyImg
	return background
...
if __name__ == "__main__":
	...
	cv2.createTrackbar('canny thresh1','panel',0,1500,dummy)
	cv2.createTrackbar('canny thresh2','panel',0,1500,dummy)



	bigImg = doAndPack(img,
		cv2.getTrackbarPos('canny thresh1','panel'),
		cv2.getTrackbarPos('canny thresh2','panel'))
