...
while True:
	...
	for cnt in contours:
		...
		cv2.rectangle(binary,(x,y),(x+w,y+h),(0,0,0),1) #http://opencv-python-tutroals.readthedocs.io/en/latest/py_tutorials/py_imgproc/py_contours/py_contour_features/py_contour_features.html
