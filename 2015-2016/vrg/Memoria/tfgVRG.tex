...
%%Ampliar
	...
	\begin{enumerate}
		...
		\item \textbf{potw1143a.jpg:} Galaxia enanas en la constelación del Phoenix.\\
	...
	Estos ficheros acompañan a la aplicación.
	\begin{figure}[!htb]
		\centering
	...
	\end{enumerate}
	Este proceso se basa, en cierta puntos en el algoritmo \textit{Algorithm for segmentation through histogram thresholding} descrito en \cite{BrainThreshold}.\\
