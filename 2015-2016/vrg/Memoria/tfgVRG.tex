...
%Meter imagen explicativa		
		...
		\end{figure}
		%Meter referencia y marcar en otro figura
...
%TODOCG: explicar que es cada cosa y que es la r.
			\begin{center}
...
%TODOCG: diferenciar pixel origen y pixel destino
			\begin{center}
