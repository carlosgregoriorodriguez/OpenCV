...
\begin{document}
	...
	\item Los ajustes heurísticos requieren afinamiento, no se descarta tomar nuevas estrategias.
	\item Optimizar, el codigo puede ser mucho más óptimo. Un claro ejemplo es la detección de estrellas y galaxias que se pueden unificar en una única función, o la gestión de las imágenes internas, en algunos casos se duplican innecesariamente imágenes (thumbnails).
	\end{itemize} 
